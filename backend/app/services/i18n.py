...
SENTENCES: dict[str, dict[str, str]] = {
    "en": {
        "calm_caregiver": "Comfortable enough for the people you look after to be outside.",
        "calm_marine": "A workable window to be on the water.",
        "calm_worker": "Exposed work can go ahead through these hours.",
        "insight_data_outlier": "At least one measured parameter sits outside its ordinary range here.",
        "vis_aviation": "Visibility is the limiting value here; check the official aviation report.",
        "vis_caregiver": "Keep those you look after indoors until visibility improves.",
        "vis_city": "Low visibility is the mobility constraint in these conditions.",
        "vis_driver": "Slow down, use low beams and leave more space until it lifts.",
        "vis_general": "Take extra care outdoors until it clears.",
        "vis_marine": "Hold off on going out until visibility opens up.",
        "vis_student": "Allow extra time and take care at road crossings on the way in.",
        "vis_traveler": "Consider putting departure back until the air clears.",
        "vis_worker": "Keep sightlines short and mark the work area clearly.",
        "insight_aviation_clear": "No convective or visibility signal in the hours ahead.",
        "insight_city_clear": "Drainage and mobility are not under load in these conditions.",
        "insight_data_clear": "Every measured parameter is inside its ordinary range in this observation.",
        "insight_home_clear": "Nothing in the day needs planning around at home.",
        "insight_journey_clear": "A clear window to travel in the hours ahead.",
    ...
    "hi": {
        "calm_caregiver": "जिनकी देखभाल करते हैं उनके बाहर रहने के लिए मौसम ठीक है।",
        "calm_marine": "पानी पर निकलने के लिए ठीक समय है।",
        "calm_worker": "इन घंटों में खुले में काम किया जा सकता है।",
        "insight_data_outlier": "यहाँ कम से कम एक मापा गया मान अपनी सामान्य सीमा से बाहर है।",
        "vis_aviation": "यहाँ दृश्यता ही सीमित करने वाला मान है; आधिकारिक विमानन रिपोर्ट देखें।",
        "vis_caregiver": "जिनकी देखभाल करते हैं उन्हें दृश्यता सुधरने तक अंदर रखें।",
        "vis_city": "इन हालात में कम दृश्यता ही आवाजाही की सबसे बड़ी अड़चन है।",
        "vis_driver": "गति घटाएँ, लो-बीम जलाएँ और साफ़ होने तक ज़्यादा दूरी रखें।",
        "vis_general": "साफ़ होने तक बाहर ज़्यादा सावधानी बरतें।",
        "vis_marine": "दृश्यता खुलने तक बाहर जाना टालें।",
        "vis_student": "आने-जाने में ज़्यादा समय रखें और सड़क पार करते समय सावधानी बरतें।",
        "vis_traveler": "हवा साफ़ होने तक निकलना टालने पर विचार करें।",
        "vis_worker": "नज़र की दूरी कम रखें और काम की जगह साफ़ तौर पर चिह्नित करें।",
        "insight_aviation_clear": "आने वाले घंटों में गरज-तूफ़ान या दृश्यता का कोई संकेत नहीं।",
        "insight_city_clear": "इन हालात में जलनिकासी और आवाजाही पर कोई दबाव नहीं।",
        "insight_data_clear": "इस अवलोकन में हर मापा गया मान अपनी सामान्य सीमा के भीतर है।",
        "insight_home_clear": "आज घर में किसी चीज़ के लिए अलग से योजना बनाने की ज़रूरत नहीं।",
        "insight_journey_clear": "आने वाले घंटों में सफ़र के लिए साफ़ समय है।",
    ...
    "te": {
        "calm_caregiver": "మీరు చూసుకునే వారు బయట ఉండటానికి వాతావరణం అనుకూలంగా ఉంది.",
        "calm_marine": "నీటిపైకి వెళ్లడానికి అనుకూల సమయం.",
        "calm_worker": "ఈ గంటల్లో బహిరంగ పనులు కొనసాగించవచ్చు.",
        "insight_data_outlier": "ఇక్కడ కనీసం ఒక కొలిచిన విలువ దాని సాధారణ పరిధి దాటి ఉంది.",
        "vis_aviation": "ఇక్కడ దృశ్యతే పరిమితం చేసే విలువ; అధికారిక విమానయాన నివేదిక చూడండి.",
        "vis_caregiver": "మీరు చూసుకునే వారిని దృశ్యత మెరుగయ్యే వరకు లోపల ఉంచండి.",
        "vis_city": "ఈ పరిస్థితుల్లో తక్కువ దృశ్యతే రాకపోకలకు ప్రధాన అడ్డంకి.",
        "vis_driver": "వేగం తగ్గించి, లో-బీమ్ వాడి, తేటపడే వరకు ఎక్కువ దూరం ఉంచండి.",
        "vis_general": "తేటపడే వరకు బయట ఎక్కువ జాగ్రత్తగా ఉండండి.",
        "vis_marine": "దృశ్యత తేటపడే వరకు బయటికి వెళ్లడం వాయిదా వేయండి.",
        "vis_student": "వెళ్లేటప్పుడు ఎక్కువ సమయం తీసుకోండి, రోడ్డు దాటేటప్పుడు జాగ్రత్త.",
        "vis_traveler": "గాలి తేటపడే వరకు బయలుదేరడాన్ని వాయిదా వేయడం పరిశీలించండి.",
        "vis_worker": "చూపు దూరం తక్కువగా ఉంచి, పని ప్రదేశాన్ని స్పష్టంగా గుర్తు పెట్టండి.",
        "insight_aviation_clear": "రాబోయే గంటల్లో ఉరుములు లేదా దృశ్యత సంబంధ సంకేతం లేదు.",
        "insight_city_clear": "ఈ పరిస్థితుల్లో డ్రైనేజీపై, రాకపోకలపై ఒత్తిడి లేదు.",
        "insight_data_clear": "ఈ పరిశీలనలో కొలిచిన ప్రతి విలువ దాని సాధారణ పరిధిలోనే ఉంది.",
        "insight_home_clear": "ఈ రోజు ఇంట్లో ప్రత్యేకంగా ప్రణాళిక వేయవలసినది ఏమీ లేదు.",
        "insight_journey_clear": "రాబోయే గంటల్లో ప్రయాణానికి అనుకూల సమయం ఉంది.",
    ...
    "bn": {
        "calm_caregiver": "যাঁদের দেখাশোনা করেন তাঁদের বাইরে থাকার মতো আরামদায়ক।",
        "calm_marine": "জলে নামার জন্য উপযুক্ত সময়।",
        "calm_worker": "এই সময়টায় খোলা জায়গার কাজ চালানো যায়।",
        "insight_data_outlier": "এখানে অন্তত একটি মাপা মান তার স্বাভাবিক সীমার বাইরে।",
        "vis_aviation": "এখানে দৃশ্যমানতাই সীমিতকারী মান; সরকারি বিমান প্রতিবেদন দেখুন।",
        "vis_caregiver": "যাঁদের দেখাশোনা করেন তাঁদের দৃশ্যমানতা ভালো না হওয়া পর্যন্ত ভিতরে রাখুন।",
        "vis_city": "এই অবস্থায় কম দৃশ্যমানতাই চলাচলের প্রধান বাধা।",
        "vis_driver": "গতি কমান, লো-বিম জ্বালুন এবং পরিষ্কার না হওয়া পর্যন্ত বেশি দূরত্ব রাখুন।",
        "vis_general": "পরিষ্কার না হওয়া পর্যন্ত বাইরে বাড়তি সতর্ক থাকুন।",
        "vis_marine": "দৃশ্যমানতা পরিষ্কার না হওয়া পর্যন্ত বেরোনো স্থগিত রাখুন।",
        "vis_student": "যাওয়ার সময় বাড়তি সময় রাখুন এবং রাস্তা পার হতে সতর্ক থাকুন।",
        "vis_traveler": "বাতাস পরিষ্কার না হওয়া পর্যন্ত রওনা পিছিয়ে দেওয়ার কথা ভাবুন।",
        "vis_worker": "দেখার দূরত্ব কম রাখুন এবং কাজের জায়গা স্পষ্ট করে চিহ্নিত করুন।",
        "insight_aviation_clear": "আগামী ঘণ্টাগুলিতে বজ্রঝড় বা দৃশ্যমানতার কোনো সংকেত নেই।",
        "insight_city_clear": "এই অবস্থায় নিকাশি ও চলাচলের উপর কোনো চাপ নেই।",
        "insight_data_clear": "এই পর্যবেক্ষণে মাপা প্রতিটি মান তার স্বাভাবিক সীমার মধ্যে।",
        "insight_home_clear": "আজ ঘরে আলাদা করে কিছু পরিকল্পনা করার দরকার নেই।",
        "insight_journey_clear": "আগামী ঘণ্টাগুলিতে যাত্রার জন্য পরিষ্কার সময় আছে।",
    ...
    "mr": {
        "calm_caregiver": "ज्यांची काळजी घेता त्यांना बाहेर राहण्यास हवामान चांगले आहे.",
        "calm_marine": "पाण्यावर जाण्यासाठी योग्य वेळ आहे.",
        "calm_worker": "या तासांत उघड्यावरचे काम करता येईल.",
        "insight_data_outlier": "इथे किमान एक मोजलेले मूल्य त्याच्या नेहमीच्या मर्यादेबाहेर आहे.",
        "vis_aviation": "इथे दृश्यमानता हाच मर्यादित करणारा घटक आहे; अधिकृत विमान अहवाल पहा.",
        "vis_caregiver": "ज्यांची काळजी घेता त्यांना दृश्यमानता सुधारेपर्यंत आत ठेवा.",
        "vis_city": "या स्थितीत कमी दृश्यमानता हीच वाहतुकीची मुख्य अडचण आहे.",
        "vis_driver": "वेग कमी करा, लो-बीम वापरा आणि साफ होईपर्यंत जास्त अंतर ठेवा.",
        "vis_general": "साफ होईपर्यंत बाहेर जास्त काळजी घ्या.",
        "vis_marine": "दृश्यमानता उघडेपर्यंत बाहेर जाणे टाळा.",
        "vis_student": "जाताना जास्त वेळ ठेवा आणि रस्ता ओलांडताना काळजी घ्या.",
        "vis_traveler": "हवा साफ होईपर्यंत निघणे पुढे ढकलण्याचा विचार करा.",
        "vis_worker": "दृष्टीचे अंतर कमी ठेवा आणि कामाची जागा स्पष्ट खुणा करा.",
        "insight_aviation_clear": "पुढील तासांत गडगडाट किंवा दृश्यमानतेचा कोणताही संकेत नाही.",
        "insight_city_clear": "या स्थितीत निचरा व वाहतुकीवर कोणताही ताण नाही.",
        "insight_data_clear": "या निरीक्षणात मोजलेले प्रत्येक मूल्य त्याच्या नेहमीच्या मर्यादेत आहे.",
        "insight_home_clear": "आज घरात वेगळे काही नियोजन करण्याची गरज नाही.",
        "insight_journey_clear": "पुढील तासांत प्रवासासाठी मोकळी वेळ आहे.",
    ...
    "as": {
        "calm_caregiver": "যিসকলৰ যত্ন লয় তেওঁলোক বাহিৰত থাকিবলৈ বতৰ ভাল।",
        "calm_marine": "পানীত নামিবলৈ উপযুক্ত সময়।",
        "calm_worker": "এই ঘণ্টাসমূহত খোলা ঠাইৰ কাম চলাব পাৰি।",
        "insight_data_outlier": "ইয়াত অন্ততঃ এটা জোখা মান তাৰ স্বাভাৱিক সীমাৰ বাহিৰত আছে।",
        "vis_aviation": "ইয়াত দৃশ্যমানতাই সীমিত কৰা মান; চৰকাৰী বিমান প্ৰতিবেদন চাওক।",
        "vis_caregiver": "যিসকলৰ যত্ন লয় তেওঁলোকক দৃশ্যমানতা উন্নত নোহোৱালৈকে ভিতৰত ৰাখক।",
        "vis_city": "এই অৱস্থাত কম দৃশ্যমানতাই চলাচলৰ মুখ্য বাধা।",
        "vis_driver": "গতি কমাওক, ল'-বীম জ্বলাওক আৰু পৰিষ্কাৰ নোহোৱালৈকে বেছি দূৰত্ব ৰাখক।",
        "vis_general": "পৰিষ্কাৰ নোহোৱালৈকে বাহিৰত অধিক সাৱধান হওক।",
        "vis_marine": "দৃশ্যমানতা মেলি নোযোৱালৈকে বাহিৰলৈ যোৱা পিছুৱাই দিয়ক।",
        "vis_student": "যাওঁতে অতিৰিক্ত সময় ৰাখক আৰু পথ পাৰ হওঁতে সাৱধান হওক।",
        "vis_traveler": "বতাহ পৰিষ্কাৰ নোহোৱালৈকে ৰাওনা পিছুৱাই দিয়াৰ কথা ভাৱক।",
        "vis_worker": "দৃষ্টিৰ দূৰত্ব কম ৰাখক আৰু কামৰ ঠাই স্পষ্টকৈ চিহ্নিত কৰক।",
        "insight_aviation_clear": "অহা ঘণ্টাসমূহত ধুমুহা বা দৃশ্যমানতাৰ কোনো সংকেত নাই।",
        "insight_city_clear": "এই অৱস্থাত নিষ্কাশন আৰু চলাচলত কোনো হেঁচা নাই।",
        "insight_data_clear": "এই পৰ্যবেক্ষণত জোখা প্ৰতিটো মান তাৰ স্বাভাৱিক সীমাৰ ভিতৰত আছে।",
        "insight_home_clear": "আজি ঘৰত পৃথককৈ একো পৰিকল্পনা কৰাৰ প্ৰয়োজন নাই।",
        "insight_journey_clear": "অহা ঘণ্টাসমূহত যাত্ৰাৰ বাবে পৰিষ্কাৰ সময় আছে।",
